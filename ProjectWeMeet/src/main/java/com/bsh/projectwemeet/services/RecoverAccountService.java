...
public class RecoverAccountService {
    ...
    public SendRecoverContactCodeResult sendRecoverContactCode(RecoverContactCodeEntity recoverContactCode, UserEntity user) {
    ...
    //    인증번호를 보낸 이후 사용할 코드
    public VerifyRecovercontactCodeResult verifyRecoverContactCodeResult(RecoverContactCodeEntity recoverContactCode, UserEntity user) {
        if (recoverContactCode == null ||
                recoverContactCode.getContact() == null ||
        ...
        recoverContactCode = this.recoverAccountMapper.selectRecoverContactCodeByCodeByContactCodeSalt(recoverContactCode, user);
